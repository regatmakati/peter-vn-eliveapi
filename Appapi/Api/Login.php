...
class Api_Login extends PhalApi_Api { 
	public function getRules() {
        return array(
			'userLogin' => array(
                'user_login' => array('name' => 'user_login', 'type' => 'string', 'require' => true,  'min' => '5',  'max'=>'30', 'desc' => '账号'),
			...
			'getCodeTest' => array(
				'mobile' => array('name' => 'mobile', 'type' => 'string', 'min' => 1, 'require' => true,  'desc' => '手机号'),
                'code' => array('name' => 'code', 'type' => 'string',  'default'=>'', 'desc' => 'code'),
			),
     ...
     * 会员登陆 需要密码
     * @desc 用于用户登陆信息
     * @return int code   操作码，0表示成功，1001-账号或密码错误，1002-禁用信息，1003-该账号已被禁用，1004-该账号已注销

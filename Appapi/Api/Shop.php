...
class Api_Shop extends PhalApi_Api {
	...
	public function getRules() {
		return array(
            ...
            'createOrder' => array(
				...
				'province' => array('name' => 'province', 'type' => 'string','require' => true, 'desc' => '所在省'),
				'city' => array('name' => 'city', 'type' => 'string','require' => true, 'desc' => '所在市'),
				'area' => array('name' => 'area', 'type' => 'string','require' => true, 'desc' => '所在区'),
				'address' => array('name' => 'address', 'type' => 'string','require' => true, 'desc' => '用户地址'),
				'username' => array('name' => 'username', 'type' => 'string','require' => true, 'desc' => '用户姓名'),
				'phone' => array('name' => 'phone', 'type' => 'string','require' => true, 'desc' => '用户电话'),
				'user_remark' => array('name' => 'user_remark', 'type' => 'string', 'desc' => '用户备注'),
	...
	public function createOrder() {
		...
		$goods_id=checkNull($this->goods_id);
		...
		$user_remark=checkNull($this->user_remark);
		
        if($uid<0 || $token=='' || $goods_id<0 || $province=='' || $city=='' || $area=='' || $address=='' || $username=='' || $phone==''){
            $rs['code'] = 1000;
			$rs['msg'] = '信息错误或地址信息不完整';
			return $rs;
        }
		...
		$res = $domain->createOrder($uid,$goods_id,$province,$city,$area,$address,$username,$phone,$user_remark);

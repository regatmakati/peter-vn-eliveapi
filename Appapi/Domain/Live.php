...
class Domain_Live {
	...
	public function teidanVote($uid,$liveuid,$id,$standpoint) {
		...
		$rs = $model->teidanVote($uid,$liveuid,$id,$standpoint);
		return $rs;
	}
	...
	public function getTeidanList($liveuid,$p) {
		...
		$model = new Model_Live();
		$rs = $model->getTeidanList($liveuid,$p);
		return $rs;
	}
	...
	/*public function getShot($liveuid,$picurl) {
		...
		$model = new Model_Live();
		$rs = $model->getShot($liveuid,$picurl);
		return $rs;
	}*/
	...
	public function updateRoom($uid,$stream,$data){
        ...
        $model = new Model_Live();
        $rs = $model->updateRoom($uid,$stream,$data);
        return $rs;
    }
    ...
    public function getLiveByMatchId($match_id,$type) {
        $rs = array();

        $model = new Model_Live();
        $rs = $model->getLiveByMatchId($match_id,$type);
        return $rs;
    }
	...
	public function getKefuList($liveuid) {
		$rs = array();

		$model = new Model_Live();
		$rs = $model->getKefuList();
		return $rs;
	}	
	...
	public function checkLiveing($uid,$liveuid,$stream) {
		$rs = array();
		$model = new Model_Live();
		$rs = $model->checkLiveing($uid,$liveuid,$stream);
		return $rs;
	}	
    ...
    public function getLiveInfo($liveuid,$uid=0) {
		$rs = array();
		$model = new Model_Live();
		$rs = $model->getLiveInfo($liveuid,$uid);
		return $rs;
	}

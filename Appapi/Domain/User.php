...
class Domain_User {
    ...
    public function getSubscribeList($uid,$p,$limit) {
        $rs = array();

        $model = new Model_User();
        $rs = $model->getSubscribeList($uid,$p,$limit);
    ...
    public function getSubscribeCount($uid) {
        ...
        $model = new Model_User();
        $rs = $model->getSubscribeCount($uid);
    ...
    public function getPCFollowsList($uid,$p,$limit) {
        ...
        $model = new Model_User();
        $rs = $model->getPCFollowsList($uid,$p,$limit);
    ...
    public function getPCFollowsCount($uid) {
        ...
        $model = new Model_User();
        $rs = $model->getPCFollowsCount($uid);
    ...
    public function getPCFansList($uid,$p,$limit) {
        ...
        $model = new Model_User();
        $rs = $model->getPCFansList($uid,$p,$limit);
    ...
    public function getPCLiverecord($param,$uid,$p) {
        ...
        $model = new Model_User();
        $rs = $model->getPCLiverecord($param,$uid,$p);
    ...
    public function getSubscribes($uid,$p) {
        ...
        $model = new Model_User();
        $key = 'getSubscribes_'.$uid.'_'.$p;
        $rs = getcaches($key);
        if(!$rs){
            $rs = $model->getSubscribes($uid,$p);
            setcaches($key,$rs,60);
        }
        return $rs;
    }
    ...
    public function PCgetSubscribes($uid) {
        ...
        $model = new Model_User();
        $key = 'PCgetSubscribes_'.$uid;
        $rs = getcaches($key);
        if(!$rs){
            $rs = $model->PCgetSubscribes($uid);
            setcaches($key,$rs,60);
        }
        return $rs;
    }

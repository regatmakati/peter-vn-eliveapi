...
return array(
    ...
    'Huawei' =>  array(
        //ak
        'accessKey' => 'HPUAOJGAONJFLUQFMNTK',
        //sk
        'secretKey' => 'SCKahJI2sZRGLPAhmQcziq4n7psWB7JzPOpN00oC',
        //endPoint
        'endPoint' => 'http://obs.ap-southeast-1.myhuaweicloud.com',
        //桶
        'bucket' => 'live-peter-ii',
        //访问域名
        'domain' => 'https://live-peter-ii.obs.ap-southeast-1.myhuaweicloud.com',
    ),
		 /**
     * 本地上传
     */
